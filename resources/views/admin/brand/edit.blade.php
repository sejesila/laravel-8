                            ...
                            <div class="card-body">
                                <form action="{{ url('brand/update/'.$brands->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group m-2 p-2">
                                        ...
                                        <input type="text" class="form-control m-2 p-2" name="brand_name" value="{{ $brands->brand_name }}">
                                    ...
                                    <div class="form-group m-2">
                                        ...
                                        <input class="form-control m-2 p-2" type="file" name="brand_image" value="{{ $brands->brand_image  }}">
