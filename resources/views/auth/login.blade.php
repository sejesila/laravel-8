            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Shule Yetu Dashboard</span>
                </a>
              </div>
            </div>
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="email" name="email" class="form-control input-lg" aria-describedby="emailHelp" autofocus placeholder="Email">
                  </div>
